...
def test_pipeline_orchestrator_happy_path(mock_api_client, mock_uploader):
    ...
    mock_uploader.upload_json.assert_any_call(
        ...
        "f1/driver_standings/season=2024/bronze_driver_standings_2024.json",
    )

    mock_uploader.upload_json.assert_any_call(
        {"dataType": "constructor_standings"},
        "f1/constructor_standings/season=2024/bronze_constructor_standings_2024.json",
    )
